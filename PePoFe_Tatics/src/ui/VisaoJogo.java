...
public class VisaoJogo extends JFrame {
	...
	private void setPersonagens(){
		...
		c.gridy = 0;
		c.gridx = 0;
		personagens.add(new JLabel(controle.getJogo().getJogador1().getNome()), c);
		...
		for(Personagem p : controle.getJogo().getJogador1().getPersonagens()){
			c.gridx = 0;
			c.gridy++;
		...
		c.gridy++;
		c.gridx = 0;
		personagens.add(new JLabel(controle.getJogo().getJogador1().getTorre().getTipo()), c);
		c.gridx = 1;
		personagens.add(new JLabel("" + controle.getJogo().getJogador1().getTorre().getVida()), c);
		c.gridx = 0;
		c.gridy++;
		...
		personagens.add(new JLabel(" "), c);
		c.gridy++;
		personagens.add(new JLabel(controle.getJogo().getJogador2().getNome()), c);
		c.gridy++;		
		personagens.add(new JLabel("Nome:"), c);
		c.gridx = 1;		
		personagens.add(new JLabel("Vida Atual:"), c);
		for(Personagem p : controle.getJogo().getJogador2().getPersonagens()){
			c.gridx = 0;
			c.gridy++;
			personagens.add(new JLabel(p.getTipo()), c);
			c.gridx = 1;
		...
		c.gridy++;
		c.gridx = 0;
		personagens.add(new JLabel(controle.getJogo().getJogador2().getTorre().getTipo()), c);
		c.gridx = 1;
		personagens.add(new JLabel("" + controle.getJogo().getJogador2().getTorre().getVida()), c);
	}
	...
	public class CellPane extends JPanel {
        ...
        public CellPane(final int x, final int y,Posicao pos) {
        	super();
        	this.posicao = pos;
        	this.setSize(32, 32);
